                ...
                child: GlassCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Teşekkür Ederiz', style: TextStyle(fontSize: 34, fontWeight: FontWeight.w800)),
                      const SizedBox(height: 12),
                      const Text(
                        'Görüşleriniz hastanemizin hizmet kalitesini iyileştirmemize yardımcı olur.',
