              ...
              child: GlassCard(
                child: Column(
                  ...
                  children: [
                        ...
                        const Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text('Mobil Memnuniyet Uygulaması', style: TextStyle(color: Color(0xFF5E7283))),
                            ],
                          ),
                        ),
                      ],
                    ...
                    const Text('Güvenli Giriş', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800)),
                    const SizedBox(height: 10),
                    const Text(
                      'Referans ekrandaki temiz, beyaz ve yumuşak cam yüzey hissini mobil tarafta koruyan giriş deneyimi.',
